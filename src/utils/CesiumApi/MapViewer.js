...
function initViewer(container, options) {
  const cesiumViewer = new Cesium.Viewer(container, options)
  ...
  cesiumViewer.scene.sun.show = true //是否显示太阳
  cesiumViewer.scene.moon.show = true //是否显示有月亮
  cesiumViewer.scene.skyAtmosphere.show = true //是否隐藏大气圈
  ...
  cesiumViewer._cesiumWidget._supportsImageRenderingPixelated = Cesium.FeatureDetection.supportsImageRenderingPixelated()
